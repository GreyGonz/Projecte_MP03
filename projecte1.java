...
public class projecte1 {
  ...
  private static void mostrarBoss() {
    System.out.println("Nom complet: " + array[casella].getNom());
    System.out.println("Entrega de la primera aparició: " + array[casella].getAparicio());
    System.out.println("Zona on es troba: " + array[casella].getZona());
    System.out.println("Tipus d'atacs: " + array[casella].getAtac());
    System.out.println("Tamany: " + array[casella].getTamany());
    System.out.println("Animes: " + array[casella].getAnimes());
    System.out.println("Descripció: " + array[casella].getDesc() + "\n");
  }
  ...
  private static void comprovaAparicio() {
    Scanner entry = new Scanner(System.in);
